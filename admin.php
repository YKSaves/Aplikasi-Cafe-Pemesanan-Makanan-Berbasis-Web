...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class=" jumbotron-fluid text-center"> 
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">HITORY CAFE </span></h1>
          <hr>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          ...
          <h5>Situjuh Batua , Situjuah Limo Nagari , Kabupaten 50 Kota 
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2020 -  Designed by Yulio Kaisar Saves</p>
          </div>
          </div>
